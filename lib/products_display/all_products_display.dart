...
import 'package:ecommerce/products_display/mobile_product_display.dart';
...
class _AllProductDisplayState extends State<AllProductDisplay> {
  ...
  void initState() {
    ...
    BlocProvider.of<ProductsBloc>(context).add(getMobileData(table: 'mobiles'));
  }
              ...
              return SizedBox(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      MobileSuccess product = state.model.success[index];
                      return InkWell(
                        onTap: () {
