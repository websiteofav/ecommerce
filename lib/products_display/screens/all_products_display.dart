...
class AllProductDisplay extends StatefulWidget {
  ...
  const AllProductDisplay({Key? key, required this.productCategory})
      : super(key: key);
...
class _AllProductDisplayState extends State<AllProductDisplay> {
  String category = '', errorMessage = '';

  MobileResponseModel? mobileModel;
        ...
        body: BlocListener<ProductsBloc, ProductsState>(
          ...
          child: BlocBuilder<ProductsBloc, ProductsState>(
            builder: (context, state) {
              if (state is ProductsLoaded && mobileModel != null) {
  ...
  Widget displayProducts() {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
          itemCount: mobileModel!.success.length,
          itemBuilder: (context, index) {
            MobileSuccessResponseModel product = mobileModel!.success[index];
            return InkWell(
              onTap: () {
